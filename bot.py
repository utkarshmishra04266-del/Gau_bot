...
TOKEN = "8940244569:AAEN4DDnyI7el9XghmQUbHtYPa9Z4EDUdHA"
ADMIN_ID = 6380152779
...
async def handle(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if txt.upper() == PASSKEY:
        unlocked.add(uid)
        await update.message.reply_text("✅ Unlocked! Ab photo/video/text bhejo")
        return
    ...
    await update.message.reply_text(f"✅ Report save ho gayi.\n🆔 Report ID: #{report_id}")
